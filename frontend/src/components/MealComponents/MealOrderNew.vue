...
export default {
  ...
  created: function() {
      ...
      if (this.tableOptions && this.tableOptions.length) this.selectedTable = this.tableOptions[0].value;
      this.sizeOptions = this.getSizeOptions(this.menu.sizes);
      if (this.sizeOptions && this.sizeOptions.length) this.selectedSize = this.sizeOptions[0].value;
      this.mealOptions = this.getMealOptions(this.menu.meals);
      if (this.mealOptions && this.mealOptions.length) this.selectedMeal = this.mealOptions[0].value;
